...
-- 22. Service Order Document Snapshots
DROP TABLE IF EXISTS service_order_document_snapshots;
CREATE TABLE service_order_document_snapshots (
    id INT AUTO_INCREMENT PRIMARY KEY,
    service_order_id INT NOT NULL,
